...
\item \textbf{Ongoing Fees} - Upon completion of the trial, the company will be charged a yearly fee based on the current number of projects being managed through {\it Acknowledgements}. This pricing scheme will allow company's to slowly adopt {\it Acknowledgements}, without large upfront costs. As user acceptance grows, the application will become critical to the client's business model.
